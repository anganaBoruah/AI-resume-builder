  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='mt-6'>
            ...
            placeholder='Write a comeplling professional summary that highlights your key strengths and career objectives...'/>

            <p className='text-xs text-gray-500 max-w-4/5 mx-auto text-center'>
                Tip: Keep it concise (3-4 sentences) and focus on yout most relevent achievments and skills.
            </p>
        </div>
