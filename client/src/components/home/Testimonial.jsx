...
const Testimonial = () => {
  return (
     ...
     <div className="flex flex-col items-center text-gray-800">
        <Title title='Proof That It Works' description='Explore success stories from users who turned their experience into opportunities with our AI resume builder.'/>
        
            <div className="flex flex-wrap items-center justify-center gap-10 mt-25 mb-20">
