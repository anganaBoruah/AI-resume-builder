...
const Hero = () => {
  ...
  return (
    ...
    <div className="min-h-screen pb-20">
                {/* Navbar */}
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm shadow-[0_2px_6px_rgba(0,0,0,0.05)]">
                    <a href="https://prebuiltui.com">
                        <img src="/logo.svg" alt='logo' className='h-11 w-auto'></img>
                    </a>

                    <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-800">
                        <a href="#" className="hover:text-violet-800 hover:scale-110 transition-all duration-500 ease-in-out">Home</a>
                        <a href="#features" className="hover:text-violet-800 hover:scale-110 transition-all duration-500 ease-in-out">Features</a>
                        <a href="#testimonials" className="hover:text-violet-800 hover:scale-110 transition-all duration-500 ease-in-out">Testimonials</a>
                        <a href="#cta" className="hover:text-violet-800 hover:scale-110 transition-all duration-500 ease-in-out">Contact</a>
                    </div>
                ...
                <div className={`fixed inset-0 z-[100] bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
                    ...
                    <button onClick={() => setMenuOpen(false)} className="active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center  transition text-white rounded-md flex" >
                        close
                    </button>
                </div>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                        ...
                        <div>
                            <div className="flex ">
                                {Array(5).fill(0).map((_, i) => (
                                    <svg key={i} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star text-transparent fill-violet-600" aria-hidden="true"><path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path></svg>
                                ))}
                            </div>
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px] ">
                        Smart, sleek, and powered by AI <span className=" bg-gradient-to-r from-violet-800 to-violet-700 bg-clip-text text-transparent text-nowrap animate-pulse">just like you. </span>
                    </h1>

                    <p className="max-w-md text-center text-base my-7">An intelligent resume builder that writes, enhances, and formats for you.</p>

                    {/* CTA Buttons */}
                    <div className="flex items-center gap-4 ">
                        <Link to='/app' className="bg-violet-700 hover:bg-violet-900 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-indigo-400 flex items-center transition-colors">
                            Get started
