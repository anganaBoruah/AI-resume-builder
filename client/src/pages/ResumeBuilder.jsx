...
const ResumeBuilder = () => {
  ...
  const saveResume = async () => {
    try {
      ...
      //remove image from updatedReusmeData
  ...
  return (
    <div>
      ...
      <div className='max-w-7xl mx-auto px-4 pb-8'>
        ...
        error: (err) => err.message || 'Could not save'})}} className='bg-gradient-to-br from-violet-100 to-violet-200 ring-violet-300 text-violet-600 hovrt:ring-green-400 transition-all rounded-md px-6 py-2 mt-6 text-sm'>
                    Save Changes
                  </button>
            </div>
          </div>  
